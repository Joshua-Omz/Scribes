...
- `__tablename__`
- `__table__`
- **`metadata`** ← This was the conflict
...
```bash
python -c "import app.models; print('✅ All models imported successfully!')"
...
# Output: ✅ All schemas imported successfully!
...
- ✅ Imports all 14 models without errors
- ✅ Imports all 73 schemas without errors
- ✅ Starts FastAPI server successfully
